...
func main() {
	...
	case "server":
		...
		if err := sentry.Init(sentry.ClientOptions{
			...
			EnableLogs:       !serverConfig.Sentry.DisableLogs,
			DisableMetrics:   serverConfig.Sentry.DisableMetrics,
	...
	case "checker":
		...
		if err := sentry.Init(sentry.ClientOptions{
			...
			EnableLogs:       !checkerConfig.Sentry.DisableLogs,
			DisableMetrics:   checkerConfig.Sentry.DisableMetrics,
			AttachStacktrace: true,
